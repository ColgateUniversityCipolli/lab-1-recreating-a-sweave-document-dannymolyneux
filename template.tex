...
\item Create a GitHub account here, and email me your user- name.
\item Install GitHub desktop
\item Accept the LAB 1 assignment here.
...
\end{kframe}
\end{knitrout}
The result is 41.0167874. Note that I did not type the result, but I used the \verb|\Sexpr{} command|.
\subsection{Plotting}
